  ...
  return (
    <div className="rounded-lg border border-zinc-800 bg-zinc-900/50 p-5">
      <h2 className="text-sm font-medium text-zinc-500 uppercase tracking-wider mb-4">
        Simulation — $1,000 Deposit
      </h2>
      <div className="grid grid-cols-3 gap-4 text-center">
        <div>
          <div className="text-xl font-bold font-[family-name:var(--font-geist-mono)] text-zinc-100">
            {formatUsd(simulation.daily_earnings_per_1k)}
          </div>
          <div className="text-xs text-zinc-500 mt-1">per day</div>
        </div>
        <div>
          <div className="text-xl font-bold font-[family-name:var(--font-geist-mono)] text-zinc-100">
